        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Proveedor = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Cliente General", "0000-0000" },
                    { 2, null, "Maria Lopez", "3001234567" },
                    { 3, null, "Carlos Perez", "3109876543" }
                });

            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "Id", "Correo", "Nombre", "Password" },
                values: new object[] { 1, "admin@inventario.com", "Administrador", "admin123" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, null, "Laptop Dell", 12500m, 10 },
                    { 2, 1, null, "Teclado Mecanico", 850m, 3 },
                    { 3, 2, null, "Camiseta Basica", 150m, 4 },
                    { 4, 3, null, "Arroz 5kg", 85m, 2 },
                    { 5, 3, null, "Aceite Oliva 1L", 180m, 1 }
                });
